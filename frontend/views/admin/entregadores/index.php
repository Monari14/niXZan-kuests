...
<head>
  ...
  <title>Todos entregadores</title>
  ...
  <style>
    ...
    #todos_entregadores tr:nth-child(even) td {
        background: var(--bg-hover);
    }
    #todos_entregadores tr:last-child td {
        border-bottom: none;
    }
    #todos_entregadores tbody tr:hover td {
        background: var(--bg-header);
        color: var(--accent);
...
<body>
      ...
      <nav class="navbar">
          ...
          <div class="navbar-actions">
              <ul class="navbar-links">
                  ...
                  <li><a href="index.php">Entregadores</a></li>
  ...
  <main>
    <div class="container">
      <div class="meio">
        <?php include 'todos_entregadores.php';?>
      </div>
      <div class="direita">
        <?php include 'adicionar_entregador.php';?>
      </div>
    </div>
  </main>
